...
const studentCategoriesRoutes = require('./studentCategories.routes');
const studentTagsRoutes = require('./studentTags.routes');
...
router.use('/student-categories', studentCategoriesRoutes);
router.use('/student-tags', studentTagsRoutes);
